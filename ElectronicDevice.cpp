...
std::string ElectronicDevice::getType() const { return type; }
...
std::string ElectronicDevice::getExtraSpec() const { return extraSpec; }

void ElectronicDevice::setType(std::string_view newType) { type = newType; }
...
void ElectronicDevice::setPrice(double newPrice) { price = newPrice; }
void ElectronicDevice::setWarrantyMonths(int months) { warrantyMonths = months; }
void ElectronicDevice::setExtraSpec(std::string_view newExtra) { extraSpec = newExtra; }
